...
import com.example.water.mymobanapplication.create.concreatebuilder.*;
...
public class Client {
    public static void main(String[] args){
        ...
        Builder builder =new XlmBuilder();
        Director director=new Director(builder);
        director.construct(exportHeaderModel,maps,exportFooterMedol);
    }
}
